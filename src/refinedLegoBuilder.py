...
# Resize the input image to 29x29
pixelated_image = input_image.resize((29, 29), Image.Resampling.NEAREST)
...
# Reshape the output back to 29x29
output_pixels = output_pixels.reshape((29, 29, 3))

# Add white borders directly into the 29x29 grid
bordered_pixels = np.full((29, 29, 3), (255, 255, 255), dtype=np.uint8)  # Start with a white image
for x in range(29):
    for y in range(29):
...
output_image.save("pixelated_output_true_29x29.jpg")
output_image.show()
